...
$sql="INSERT INTO caches (code, name, owner,latitude,longitude,altitude,kind,size,difficulty,terrain,favorites,founds,not_founds,state,county,publish,status,last_log)
VALUES
